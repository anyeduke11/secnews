...
export function Header({
  ...
  return (
    <header className="mb-4" style={{ borderBottom: '2px solid var(--text-primary)' }}>
      {/* ── Masthead: 报头靠左 + 右侧两行堆叠 (上: 动作组 / 下: 栏目导航, 均靠右) ── */}
      <div className="flex items-end flex-wrap gap-x-5 gap-y-2 py-4 sm:py-5">
        ...
        <div className="ml-auto flex flex-col items-end gap-1.5 min-w-0 max-w-full">
          <div className="flex items-center justify-end gap-0.5">
            {actionButtons}
          </div>
          <nav
            className="flex items-center gap-1.5 overflow-x-auto max-w-full text-[11.5px]"
